...
public class IndexModel : PageModel
{
    ...
    public void OnGet()
    {
        ...
        members[1] = new Member("Franz Beckerlee", "pictures/franz-beckerlee.jpg", "Guitarist", 1942, 0, "FranzBeckerlee");
        ...
        members[4] = new Member("Søren Berlev", "pictures/soeren-berlev.jpg", "Trommeslager", 1950, 0, "SørenBerlev");
    }
}
